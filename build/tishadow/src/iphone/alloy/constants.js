...
if (isTitanium) {
    _ = __p.require("alloy/underscore")._;
} else {
    var platforms = __p.require("platforms/index");
    _ = __p.require("iphone/lib/alloy/underscore")._;
...
exports.DIST_TYPES = [ {
    ...
    key: "DIST_STORE",
    value: [ "dist-appstore", "dist-playstore" ]
} ];
...
exports.IMPLICIT_NAMESPACES = {
    ...
    NavigationGroup: isTitanium && Ti.Platform.osname === "mobileweb" ? NS_TI_UI_MOBILEWEB : NS_TI_UI_IPHONE,
