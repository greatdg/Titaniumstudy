...
module.exports = function(widgetId) {
    ...
    this.createController = function(name, args) {
        return new (__p.require("alloy/widgets/" + widgetId + "/controllers/" + name))(args);
    };
    this.createCollection = function(name, args) {
        return new (__p.require("alloy/widgets/" + widgetId + "/models/" + ucfirst(name)).Collection)(args);
    };
    this.createModel = function(name, args) {
        return new (__p.require("alloy/widgets/" + widgetId + "/models/" + ucfirst(name)).Model)(args);
    };
