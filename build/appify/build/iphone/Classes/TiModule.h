...
/**
 The base class for all damate modules
 */
...
/**
 damate Platform calls this method on startup.
 */
-(void)startup;

/**
 damate Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 damate Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 damate Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 damate Platform calls this method on resume.
 @param sender The sender of the event.
 */
