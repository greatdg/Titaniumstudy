...
// in simulator we redefine to format for damate Developer console
...
{\
	NSString * exceptionName = [@"org.damate." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.damate";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIdamateNativeItemNone = -1, 
	UIdamateNativeItemSpinner = -2,
	UIdamateNativeItemProgressBar = -3,
	
	UIdamateNativeItemSlider = -4,
	UIdamateNativeItemSwitch = -5,
	UIdamateNativeItemMultiButton = -6,
	UIdamateNativeItemSegmented = -7,
	
	UIdamateNativeItemTextView = -8,
	UIdamateNativeItemTextField = -9,
	UIdamateNativeItemSearchBar = -10,
	
	UIdamateNativeItemPicker = -11,
	UIdamateNativeItemDatePicker = -12,
	
	UIdamateNativeItemInfoLight = -13,
	UIdamateNativeItemInfoDark = -14,
	
	UIdamateNativeItemDisclosure = -15,
	
	UIdamateNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all damate instances of
